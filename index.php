...
<body>
    <div class="container">
        ...
        if (isset($_SESSION['yetki'])) { ?>
            ...
            <a class="button button-primary red" value="ekle" href="./php/control.php?cikis=1">çıkış yap</a>
            <?php } else 
            echo '<a class="button button-primary green" value="ekle" href="./php/login.php">giriş yap</a>';
            ?>
